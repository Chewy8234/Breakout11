...
// desc: implentation of a player paddle block class object
// ********************************************************
...
/**
* determine current paddle movement direction from its
* velocity (None = 0, left = neg, Right = pos)
* Returns:
...
* collison checking with left and right walls
* Parameters:
